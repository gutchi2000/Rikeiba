...
debug_df = pd.DataFrame({
    ...
    '平均Z': [df[m].mean() for m in ['Z_raw_n','Z_up3_n','Z_odds_n','Z_jin_n','Z_today_n','Z_dist_n','Z_wd_n']("_")[1]}'].mean() for m in ['Z_raw_n','Z_up3_n','Z_odds_n','Z_jin_n','Z_today_n','Z_dist_n','Z_wd_n']]
})
st.table(debug_df)
