...
# マージ
df = df.merge(
    stats[['馬名','性別','年齢','best_dist_time']], on='馬名', how='left'
)
...
weights = {'Z_raw':8,'Z_up3_norm':2,'Z_odds_norm':1,'Z_jin_norm':w_jin,'Z_today_norm':w_jin,'Z_dist_norm':w_best_dist,'Z_wdiff_norm':1,'Z_pedigree_factor':3,'Z_age_factor':2,'Z_style_factor':2,'Z_seasonal_factor':2}
...
if zmax>zmin:
    summary['偏差値'] = 30+(summary['mean_z']-zmin)/(zmax-zmin)*40
else:
    summary['偏差値'] = 50
